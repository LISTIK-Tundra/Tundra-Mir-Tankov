# 🌲 Tundra Mir Tankov — Ваш инструмент для чистого поля боя
...
1.  Скачайте последнюю версию программы из раздела [Releases](https://github.com/LISTIK-Tundra/Tundra-Mir-Tankov/releases) (или соберите из исходников).
